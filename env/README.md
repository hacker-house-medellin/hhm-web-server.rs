...
- **No multi-line values.** A PEM must be represented as one quoted dotenv
  value containing literal `\n` escape sequences between its header, body, and
  footer. Never paste even an example credential-shaped block into source docs.
