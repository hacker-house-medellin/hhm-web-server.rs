//! Four-avenue web ↔ API binding for `hacker-house-medellin`.
//!
//! 1. Direct read-only DB via `*-lib-core` named queries (no migrations).
//! 2. Stateless HTTP from `app.hacker-house-medellin.dev` to `api.hacker-house-medellin.dev`.
//! 3. Stateful TLS 1.3/mTLS TCP to `api.hacker-house-medellin.dev:7443`.
...
pub const GITHUB_ORG: &str = "hacker-house-medellin";
pub const ORG_SLUG: &str = "hhm";
pub const DNS_ZONE: &str = "hacker-house-medellin.dev";
